...
<html lang="en">
	...
	<style>
    .tabmenu {position:relative; width:100%; height:10px;
		...
		$(document).ready(function(){
	        $(".tabmenu").each(function(){
	            ...
	            tabBtn.click(function(){
	            	alert($(this).attr("id"));
	            	if($(this).attr("id")=="orderList"){
	            		$("#frame_order").show();
	            		$("#frame_deposit").hide();
	            		
	            		document.orderList_pop.submit();
	            	}else if($(this).attr("id")=="depositList"){
	            		$("#frame_deposit").show();
	            		$("#frame_order").hide();
	            		
	            		document.depositList_pop.submit();
	            	}
	                // 이미 on 상태면 pass
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<form method="post" action="#">
								<h4>Alternate</h4>
								    ...
								    <ul>
								        ...
								        <li><a href="#link" id="depositList" name="depositList"><img src="/first/images/menu_02_off.gif" alt="메뉴02" /></a>
								        </li>
							...
							<form name="orderList_pop" id="orderList_pop" method = "post" action="orderList_pop.do" target="frame_order">
								    	<input type="hidden" name="order_pop_user_id" id = "order_pop_user_id" value="<%=user_id%>">
								    	<iframe id="frame_order" name="frame_order"  height="400" style="overflow:visible;  height:400;width:100%;" scrolling ="auto" src = "">
								    	</iframe>
						    </form>
							<form name="depositList_pop" id="depositList_pop" method = "post" action="depositList_pop.do" target="frame_deposit">
								    	<input type="hidden" name="deposit_pop_user_id" id = "deposit_pop_user_id" value="<%=user_id%>">
								    	<iframe id="frame_deposit" name="frame_deposit"  height="400" style="overflow:visible;  height:400;width:100%;" scrolling ="auto" src = "">
								    	</iframe>
						    </form>
				    	</div>
				    </div>
