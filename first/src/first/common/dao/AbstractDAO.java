...
public class AbstractDAO {
	...
	public Map selectPagingList(String queryId, Object params){
	    ...
	    if(map.containsKey("currentPageNo") == false || StringUtils.isNullOrEmpty((String)map.get("currentPageNo")) == true)
	        map.put("currentPageNo","1");
	     
	    paginationInfo = new PaginationInfo();
	    paginationInfo.setCurrentPageNo(Integer.parseInt(map.get("currentPageNo").toString()));
	    if(map.containsKey("PAGE_ROW") == false || StringUtils.isNullOrEmpty((String) map.get("PAGE_ROW")) == true){
